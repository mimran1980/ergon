...
- [x] Integration test: custom metrics impl verifies hook calls (DECLINED — unit tests cover NoopMetrics + CountingMetrics; Docker integration test is over-engineering for metrics hooks)
