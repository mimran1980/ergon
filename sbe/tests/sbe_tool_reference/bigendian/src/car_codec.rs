...
pub const SBE_BLOCK_LENGTH: u16 = 49;
...
pub mod encoder {
    ...
    impl<'a> CarEncoder<'a> {
        ...
        pub fn some_numbers_zero_padded(&mut self, value: &[u32]) -> &mut Self {
            let iter = value.iter().copied().chain(std::iter::repeat(0_u32)).take(5);
...
pub mod decoder {
    ...
    impl<'a> CarDecoder<'a> {
        ...
        #[inline]
        pub fn some_numbers(&self) -> [u32; 5] {
            ...
            [
                ...
                buf.get_u32_at(self.offset + 12 + 16),
            ]
        }
