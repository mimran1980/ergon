...
pub use decoder::TestMessage4Decoder;
pub use encoder::TestMessage4Encoder;
...
pub mod encoder {
    ...
    pub struct TestMessage4Encoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for TestMessage4Encoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for TestMessage4Encoder<'a> {
        #[inline]
...
pub mod decoder {
    ...
    pub struct TestMessage4Decoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for TestMessage4Decoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for TestMessage4Decoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for TestMessage4Decoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
