...
pub mod encoder {
    ...
    impl<'a> CarEncoder<'a> {
        ...
        /// - version: 0
        #[inline]
        pub fn serial_number(&mut self, value: u32) -> &mut Self {
        ...
        #[inline]
        pub fn some_numbers_at(&mut self, index: usize, value: i32) -> &mut Self {
        ...
        /// - version: 0
        #[inline]
        pub fn some_numbers(&mut self, value: &[i32]) -> &mut Self {
        ...
        /// - version: 0
        #[inline]
        pub fn some_numbers_from_iter(&mut self, iter: impl Iterator<Item = i32>) -> &mut Self {
            let offset = self.offset + 8;
            let buf = self.get_buf_mut();
        ...
        /// - version: 0
        #[inline]
        pub fn some_numbers_zero_padded(&mut self, value: &[i32]) -> &mut Self {
        ...
        /// VAR_DATA ENCODER - character encoding: 'ISO-8859-1'
        #[inline]
        pub fn manufacturer(&mut self, value: &[u8]) -> &mut Self {
        ...
        /// VAR_DATA ENCODER - character encoding: 'ISO-8859-1'
        #[inline]
        pub fn model(&mut self, value: &[u8]) -> &mut Self {
            let limit = self.get_limit();
            let data_length = value.len().min((u32::MAX - 1) as usize);
            self.set_limit(limit + 4 + data_length);
            self.get_buf_mut().put_u32_at(limit, data_length as u32);
...
pub mod decoder {
    ...
    impl<'a> CarDecoder<'a> {
        ...
        pub fn some_numbers(&self) -> [i32; 5] {
            ...
            [
                buf.get_i32_at(self.offset + 8),
                buf.get_i32_at(self.offset + 8 + 4),
                buf.get_i32_at(self.offset + 8 + 8),
                buf.get_i32_at(self.offset + 8 + 12),
                buf.get_i32_at(self.offset + 8 + 16),
            ]
        }
        ...
        /// VAR_DATA DECODER - character encoding: 'ISO-8859-1'
        #[inline]
    ...
    impl<'a, P> FuelFiguresDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        ...
        /// group token - Token{signal=BEGIN_GROUP, name='fuelFigures', referencedName='null', description='null', packageName='null', id=9, version=0, deprecated=0, encodedLength=6, offset=41, componentTokenCount=12, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
        #[inline]
        pub fn parent(&mut self) -> SbeResult<P> {
            self.parent.take().ok_or(SbeErr::ParentNotSet)
        }
    ...
    impl<'a, P> PerformanceFiguresDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        ...
        /// group token - Token{signal=BEGIN_GROUP, name='performanceFigures', referencedName='null', description='null', packageName='null', id=12, version=0, deprecated=0, encodedLength=1, offset=-1, componentTokenCount=21, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
        #[inline]
        pub fn parent(&mut self) -> SbeResult<P> {
            self.parent.take().ok_or(SbeErr::ParentNotSet)
        }
    ...
    impl<'a, P> AccelerationDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        ...
        /// group token - Token{signal=BEGIN_GROUP, name='acceleration', referencedName='null', description='null', packageName='null', id=14, version=0, deprecated=0, encodedLength=6, offset=1, componentTokenCount=12, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
        #[inline]
        pub fn parent(&mut self) -> SbeResult<P> {
            self.parent.take().ok_or(SbeErr::ParentNotSet)
        }
