...
pub mod encoder {
    ...
    impl<'a> CarEncoder<'a> {
        ...
        #[inline]
        pub fn color(&mut self, value: &[u8]) -> &mut Self {
            let limit = self.get_limit();
...
pub mod decoder {
    ...
    impl<'a> CarDecoder<'a> {
        ...
        pub fn some_numbers(&self) -> [i32; 5] {
            ...
            [
                buf.get_i32_at(self.offset + 12),
                buf.get_i32_at(self.offset + 12 + 4),
                buf.get_i32_at(self.offset + 12 + 8),
                buf.get_i32_at(self.offset + 12 + 12),
                buf.get_i32_at(self.offset + 12 + 16),
            ]
        }
        ...
        pub fn extras(&self) -> optional_extras::OptionalExtras {
            optional_extras::OptionalExtras::new(self.get_buf().get_u8_at(self.offset + 38))
        }
        ...
        #[inline]
        pub fn color_decoder(&mut self) -> (usize, usize) {
            let offset = self.get_limit();
        ...
        #[inline]
        pub fn color_slice(&'a self, coordinates: (usize, usize)) -> &'a [u8] {
            debug_assert!(self.get_limit() >= coordinates.0 + coordinates.1);
            self.get_buf().get_slice_at(coordinates.0, coordinates.1)
        }
