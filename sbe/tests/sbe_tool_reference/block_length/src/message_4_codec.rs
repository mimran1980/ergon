...
pub use decoder::Message4Decoder;
pub use encoder::Message4Encoder;
...
pub mod encoder {
    ...
    impl<'a> Writer<'a> for Message4Encoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for Message4Encoder<'a> {
        #[inline]
...
pub mod decoder {
    ...
    impl ActingVersion for Message4Decoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for Message4Decoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for Message4Decoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
