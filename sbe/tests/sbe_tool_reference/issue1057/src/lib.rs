...
pub mod event_indicator;
pub mod execution_report_new_codec;
pub mod message_header_codec;
pub mod outbound_business_header_codec;

pub const SBE_SCHEMA_ID: u16 = 1057;
pub const SBE_SCHEMA_VERSION: u16 = 4;
pub const SBE_SEMANTIC_VERSION: &str = "8.2.3";
