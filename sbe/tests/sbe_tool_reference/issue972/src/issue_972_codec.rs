...
pub use decoder::Issue972Decoder;
pub use encoder::Issue972Encoder;
...
pub mod encoder {
    ...
    impl<'a> Writer<'a> for Issue972Encoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for Issue972Encoder<'a> {
        #[inline]
...
pub mod decoder {
    ...
    impl ActingVersion for Issue972Decoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for Issue972Decoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for Issue972Decoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> Issue972Decoder<'a> {
        ...
        /// COMPOSITE DECODER
        #[inline]
        pub fn new_field_decoder(self) -> Either<Self, new_composite_codec::NewCompositeDecoder<Self>> {
            if self.acting_version() < 1 {
                return Either::Left(self);
            }

            let offset = self.offset + 2;
            Either::Right(new_composite_codec::NewCompositeDecoder::default().wrap(self, offset))
        }
