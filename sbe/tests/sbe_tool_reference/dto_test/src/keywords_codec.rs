...
pub use decoder::KeywordsDecoder;
pub use encoder::KeywordsEncoder;
...
pub mod encoder {
    ...
    impl<'a> Writer<'a> for KeywordsEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for KeywordsEncoder<'a> {
        #[inline]
    ...
    impl<'a> KeywordsEncoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn r#continue(&mut self, value: model::Model) -> &mut Self {
    ...
    impl<'a, P> SuperEncoder<P> where P: Encoder<'a> + Default {
        ...
        #[inline]
        pub fn r#true_at(&mut self, index: usize, value: i32) -> &mut Self {
            let offset = self.offset + 19;
            let buf = self.get_buf_mut();
            buf.put_i32_at(offset + index * 4, value);
            self
        ...
        /// - version: 3
        #[inline]
        pub fn r#true(&mut self, value: &[i32]) -> &mut Self {
            debug_assert_eq!(5, value.len());
            let offset = self.offset + 19;
            let buf = self.get_buf_mut();
            buf.put_i32_at(offset, value[0]);
        ...
        /// primitive array field 'true' from an Iterator
        /// - min value: -2147483647
        /// - max value: 2147483647
        /// - null value: -2147483648_i32
        /// - characterEncoding: null
        ...
        /// - version: 3
        #[inline]
        pub fn r#true_from_iter(&mut self, iter: impl Iterator<Item = i32>) -> &mut Self {
            let offset = self.offset + 19;
            let buf = self.get_buf_mut();
            for (i, v) in iter.enumerate() {
                buf.put_i32_at(offset + i * 4, v);
        ...
        /// primitive array field 'true' with zero padding
        /// - min value: -2147483647
        /// - max value: 2147483647
        /// - null value: -2147483648_i32
        /// - characterEncoding: null
        ...
        /// - version: 3
        #[inline]
        pub fn r#true_zero_padded(&mut self, value: &[i32]) -> &mut Self {
            let iter = value.iter().copied().chain(std::iter::repeat(0_i32)).take(5);
            self.r#true_from_iter(iter);
            self
        }
...
pub mod decoder {
    ...
    impl ActingVersion for KeywordsDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for KeywordsDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for KeywordsDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> KeywordsDecoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn r#continue(&self) -> model::Model {
        ...
        /// COMPOSITE DECODER
        #[inline]
        pub fn true_decoder(self) -> Either<Self, array_pair_codec::ArrayPairDecoder<Self>> {
            if self.acting_version() < 4 {
                return Either::Left(self);
            }

            let offset = self.offset + 84;
            Either::Right(array_pair_codec::ArrayPairDecoder::default().wrap(self, offset))
        }
    ...
    impl<'a, P> SuperDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        ...
        /// group token - Token{signal=BEGIN_GROUP, name='super', referencedName='null', description='null', packageName='null', id=92, version=0, deprecated=0, encodedLength=39, offset=1, componentTokenCount=27, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
        #[inline]
        pub fn parent(&mut self) -> SbeResult<P> {
            self.parent.take().ok_or(SbeErr::ParentNotSet)
        }
        ...
        pub fn r#true(&self) -> [i32; 5] {
            ...
            let buf = self.get_buf();
            [
                buf.get_i32_at(self.offset + 19),
                buf.get_i32_at(self.offset + 19 + 4),
                buf.get_i32_at(self.offset + 19 + 8),
                buf.get_i32_at(self.offset + 19 + 12),
                buf.get_i32_at(self.offset + 19 + 16),
            ]
        }
