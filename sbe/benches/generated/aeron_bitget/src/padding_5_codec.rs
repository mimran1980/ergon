...
pub use encoder::Padding5Encoder;
pub use decoder::Padding5Decoder;
...
pub mod encoder {
    ...
    pub struct Padding5Encoder<P> {
        parent: Option<P>,
        offset: usize,
    }

    impl<'a, P> Writer<'a> for Padding5Encoder<P> where P: Writer<'a> + Default {
        #[inline]
    ...
    impl<'a, P> Padding5Encoder<P> where P: Writer<'a> + Default {
...
pub mod decoder {
    ...
    #[derive(Debug, Default)]
    pub struct Padding5Decoder<P> {
        parent: Option<P>,
        offset: usize,
    }

    impl<'a, P> ActingVersion for Padding5Decoder<P> where P: Reader<'a> + ActingVersion + Default {
        #[inline]
    ...
    impl<'a, P> Reader<'a> for Padding5Decoder<P> where P: Reader<'a> + Default {
        #[inline]
    ...
    impl<'a, P> Padding5Decoder<P> where P: Reader<'a> + Default {
        pub fn wrap(mut self, parent: P, offset: usize) -> Self {
            self.parent = Some(parent);
            self.offset = offset;
            self
