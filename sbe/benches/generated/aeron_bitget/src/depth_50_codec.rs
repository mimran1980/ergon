...
pub use decoder::Depth50Decoder;
pub use encoder::Depth50Encoder;
...
pub mod encoder {
    ...
    impl<'a> Writer<'a> for Depth50Encoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for Depth50Encoder<'a> {
        #[inline]
...
pub mod decoder {
    ...
    impl ActingVersion for Depth50Decoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for Depth50Decoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for Depth50Decoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a, P> AsksDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        ...
        /// group token - Token{signal=BEGIN_GROUP, name='asks', referencedName='null', description='null', packageName='null', id=200, version=0, deprecated=0, encodedLength=16, offset=32, componentTokenCount=12, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
        #[inline]
        pub fn parent(&mut self) -> SbeResult<P> {
            self.parent.take().ok_or(SbeErr::ParentNotSet)
        }
    ...
    impl<'a, P> BidsDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        ...
        /// group token - Token{signal=BEGIN_GROUP, name='bids', referencedName='null', description='null', packageName='null', id=300, version=0, deprecated=0, encodedLength=16, offset=-1, componentTokenCount=12, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
        #[inline]
        pub fn parent(&mut self) -> SbeResult<P> {
            self.parent.take().ok_or(SbeErr::ParentNotSet)
        }
