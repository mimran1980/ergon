...
// #![allow(dead_code)]
// #![doc = "sbe-tool (official simple-binary-encoding) Rust SBE generated code for the Car example schema (baseline)."]
    ...
    pub mod car_codec {
        ...
        pub mod decoder {
            ...
            impl<'a> CarDecoder<'a> {
                ...
                pub fn header(
                    self,
                    mut header: MessageHeaderDecoder<ReadBuf<'a>>,
                    offset: usize,
                ) -> Self {
    ...
    pub mod engine_codec {
        ...
        pub mod encoder {
                ...
                P: Writer<'a> + Default,
            {
                ...
                /// - version: 0
                #[inline]
                pub fn manufacturer_code_from_iter(
                    &mut self,
                    iter: impl Iterator<Item = u8>,
                ) -> &mut Self {
                    let offset = self.offset + 3;
