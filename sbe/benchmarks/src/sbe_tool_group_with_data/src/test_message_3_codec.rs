...
pub mod encoder {
        ...
        P: Encoder<'a> + Default,
    {
        ...
        /// GROUP ENCODER (id=4)
        #[inline]
        pub fn nested_entries_encoder(
            self,
            count: u8,
            nested_entries_encoder: NestedEntriesEncoder<Self>,
        ) -> NestedEntriesEncoder<Self> {
    ...
    impl<'a, P> Writer<'a> for NestedEntriesEncoder<P>
    where
        P: Writer<'a> + Default,
    {
        #[inline]
    ...
    impl<'a, P> Encoder<'a> for NestedEntriesEncoder<P>
    where
        P: Encoder<'a> + Default,
    {
        #[inline]
    ...
    impl<'a, P> NestedEntriesEncoder<P>
    where
        P: Encoder<'a> + Default,
    {
        #[inline]
...
pub mod decoder {
    ...
    impl<'a, P> ActingVersion for NestedEntriesDecoder<P>
    where
        P: Reader<'a> + ActingVersion + Default,
    {
        #[inline]
    ...
    impl<'a, P> Reader<'a> for NestedEntriesDecoder<P>
    where
        P: Reader<'a> + Default,
    {
        #[inline]
    ...
    impl<'a, P> Decoder<'a> for NestedEntriesDecoder<P>
    where
        P: Decoder<'a> + ActingVersion + Default,
    {
        #[inline]
    ...
    impl<'a, P> NestedEntriesDecoder<P>
    where
        P: Decoder<'a> + ActingVersion + Default,
    {
        pub fn wrap(mut self, mut parent: P) -> Self {
