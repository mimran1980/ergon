...
pub mod encoder {
    ...
    impl<'a, P> Writer<'a> for OptionalCompositeEncoder<P>
    where
        P: Writer<'a> + Default,
    {
        #[inline]
    ...
    impl<'a, P> OptionalCompositeEncoder<P>
    where
        P: Writer<'a> + Default,
    {
...
pub mod decoder {
    ...
    impl<'a, P> ActingVersion for OptionalCompositeDecoder<P>
    where
    ...
    impl<'a, P> Reader<'a> for OptionalCompositeDecoder<P>
    where
        P: Reader<'a> + Default,
    {
        #[inline]
    ...
    impl<'a, P> OptionalCompositeDecoder<P>
    where
        P: Reader<'a> + Default,
    {
        pub fn wrap(mut self, parent: P, offset: usize) -> Self {
