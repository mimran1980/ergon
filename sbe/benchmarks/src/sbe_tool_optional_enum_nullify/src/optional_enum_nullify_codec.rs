...
pub mod encoder {
    ...
    impl<'a> OptionalEnumNullifyEncoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn required_enum_from_optional_type(
            &mut self,
            value: optional_encoding_enum_type::OptionalEncodingEnumType,
        ) -> &mut Self {
        ...
        /// COMPOSITE ENCODER
        #[inline]
        pub fn optional_composite_encoder(
            self,
        ) -> optional_composite_codec::OptionalCompositeEncoder<Self> {
...
pub mod decoder {
    ...
    impl<'a> OptionalEnumNullifyDecoder<'a> {
        ...
        pub fn required_enum_from_optional_type(
            &self,
        ) -> optional_encoding_enum_type::OptionalEncodingEnumType {
            self.get_buf().get_u8_at(self.offset + 1).into()
        }

        /// COMPOSITE DECODER
        #[inline]
        pub fn optional_composite_decoder(
            self,
        ) -> optional_composite_codec::OptionalCompositeDecoder<Self> {
            let offset = self.offset + 2;
