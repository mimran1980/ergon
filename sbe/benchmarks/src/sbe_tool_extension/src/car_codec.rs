...
pub mod encoder {
    ...
    impl<'a> CarEncoder<'a> {
        ...
        #[inline]
        pub fn uuid_at(&mut self, index: usize, value: i64) -> &mut Self {
        ...
        /// - version: 1
        #[inline]
        pub fn uuid(&mut self, value: &[i64]) -> &mut Self {
        ...
        /// primitive array field 'uuid' from an Iterator
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808_i64
        /// - characterEncoding: null
        ...
        /// - version: 1
        #[inline]
        pub fn uuid_from_iter(&mut self, iter: impl Iterator<Item = i64>) -> &mut Self {
            let offset = self.offset + 45;
            let buf = self.get_buf_mut();
            for (i, v) in iter.enumerate() {
        ...
        /// primitive array field 'uuid' with zero padding
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808_i64
        /// - characterEncoding: null
        ...
        /// - version: 1
        #[inline]
        pub fn uuid_zero_padded(&mut self, value: &[i64]) -> &mut Self {
            let iter = value
                .iter()
                .copied()
                .chain(std::iter::repeat(0_i64))
                .take(2);
            self.uuid_from_iter(iter);
            self
        }

        /// primitive field 'cupHolderCount'
        /// - min value: 0
        /// - max value: 254
        /// - null value: 0xff_u8
        /// - characterEncoding: null
        ...
        /// - version: 1
        #[inline]
        pub fn cup_holder_count(&mut self, value: u8) -> &mut Self {
            let offset = self.offset + 61;
            self.get_buf_mut().put_u8_at(offset, value);
            self
        }

        /// optional primitive field 'cupHolderCount'
        /// - min value: 0
        /// - max value: 254
        /// - null value: 0xff_u8
        /// - characterEncoding: null
        ...
        #[inline]
        pub fn cup_holder_count_opt(&mut self, value: Option<u8>) -> &mut Self {
            match value {
                Some(value) => self.cup_holder_count(value),
                None => self.cup_holder_count(0xff_u8),
            };
            self
        }
        ...
        /// GROUP ENCODER (id=10)
        #[inline]
        pub fn fuel_figures_encoder(
            self,
            count: u16,
            fuel_figures_encoder: FuelFiguresEncoder<Self>,
        ) -> FuelFiguresEncoder<Self> {
            fuel_figures_encoder.wrap(self, count)
        }

        /// GROUP ENCODER (id=13)
        #[inline]
        pub fn performance_figures_encoder(
            self,
            count: u16,
            performance_figures_encoder: PerformanceFiguresEncoder<Self>,
        ) -> PerformanceFiguresEncoder<Self> {
    ...
    impl<'a, P> Writer<'a> for FuelFiguresEncoder<P>
    where
        P: Writer<'a> + Default,
    {
        #[inline]
    ...
    impl<'a, P> Encoder<'a> for FuelFiguresEncoder<P>
    where
        P: Encoder<'a> + Default,
    {
        #[inline]
    ...
    impl<'a, P> Writer<'a> for PerformanceFiguresEncoder<P>
    where
        P: Writer<'a> + Default,
    {
        #[inline]
    ...
    impl<'a, P> Encoder<'a> for PerformanceFiguresEncoder<P>
    where
        P: Encoder<'a> + Default,
    {
        #[inline]
    ...
    impl<'a, P> PerformanceFiguresEncoder<P>
    where
        P: Encoder<'a> + Default,
    {
        #[inline]
        ...
        /// GROUP ENCODER (id=15)
        #[inline]
        pub fn acceleration_encoder(
            self,
            count: u16,
            acceleration_encoder: AccelerationEncoder<Self>,
        ) -> AccelerationEncoder<Self> {
    ...
    impl<'a, P> Writer<'a> for AccelerationEncoder<P>
    where
        P: Writer<'a> + Default,
    {
        #[inline]
    ...
    impl<'a, P> Encoder<'a> for AccelerationEncoder<P>
    where
        P: Encoder<'a> + Default,
    {
        #[inline]
    ...
    impl<'a, P> AccelerationEncoder<P>
    where
        P: Encoder<'a> + Default,
    {
        #[inline]
...
pub mod decoder {
    ...
    impl<'a> CarDecoder<'a> {
        ...
        #[inline]
        pub fn uuid(&self) -> [i64; 2] {
            if self.acting_version() < 1 {
                return [-9223372036854775808_i64; 2];
            }

            let buf = self.get_buf();
            [
                buf.get_i64_at(self.offset + 45),
                buf.get_i64_at(self.offset + 45 + 8),
            ]
        }

        /// primitive field - 'OPTIONAL' { null_value: '0xff_u8' }
        #[inline]
        pub fn cup_holder_count(&self) -> Option<u8> {
            if self.acting_version() < 1 {
                return None;
            }

            let value = self.get_buf().get_u8_at(self.offset + 61);
            if value == 0xff_u8 {
                None
            } else {
                Some(value)
    ...
    impl<'a, P> ActingVersion for FuelFiguresDecoder<P>
    where
    ...
    impl<'a, P> Reader<'a> for FuelFiguresDecoder<P>
    where
        P: Reader<'a> + Default,
    {
        #[inline]
    ...
    impl<'a, P> Decoder<'a> for FuelFiguresDecoder<P>
    where
        ...
        P: Decoder<'a> + ActingVersion + Default,
    {
        ...
        /// group token - Token{signal=BEGIN_GROUP, name='fuelFigures', referencedName='null', description='null', packageName='null', id=10, version=0, deprecated=0, encodedLength=6, offset=62, componentTokenCount=18, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
        #[inline]
        pub fn parent(&mut self) -> SbeResult<P> {
            self.parent.take().ok_or(SbeErr::ParentNotSet)
        }
    ...
    impl<'a, P> ActingVersion for PerformanceFiguresDecoder<P>
    where
        P: Reader<'a> + ActingVersion + Default,
    {
        #[inline]
    ...
    impl<'a, P> Reader<'a> for PerformanceFiguresDecoder<P>
    where
        P: Reader<'a> + Default,
    {
        #[inline]
    ...
    impl<'a, P> Decoder<'a> for PerformanceFiguresDecoder<P>
    where
        P: Decoder<'a> + ActingVersion + Default,
    {
        #[inline]
    ...
    impl<'a, P> PerformanceFiguresDecoder<P>
    where
        P: Decoder<'a> + ActingVersion + Default,
    {
        pub fn wrap(mut self, mut parent: P) -> Self {
    ...
    impl<'a, P> ActingVersion for AccelerationDecoder<P>
    where
        P: Reader<'a> + ActingVersion + Default,
    {
        #[inline]
    ...
    impl<'a, P> Reader<'a> for AccelerationDecoder<P>
    where
        P: Reader<'a> + Default,
    {
        #[inline]
    ...
    impl<'a, P> Decoder<'a> for AccelerationDecoder<P>
    where
        P: Decoder<'a> + ActingVersion + Default,
    {
        #[inline]
    ...
    impl<'a, P> AccelerationDecoder<P>
    where
        P: Decoder<'a> + ActingVersion + Default,
    {
        pub fn wrap(mut self, mut parent: P) -> Self {
