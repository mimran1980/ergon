...
pub mod encoder {
    ...
    impl<'a, P> Writer<'a> for EngineEncoder<P>
    where
        P: Writer<'a> + Default,
    {
        #[inline]
...
pub mod decoder {
    ...
    impl<'a, P> ActingVersion for EngineDecoder<P>
    where
    ...
    impl<'a, P> Reader<'a> for EngineDecoder<P>
    where
        P: Reader<'a> + Default,
    {
        #[inline]
