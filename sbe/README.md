...
> Details of process and ownership: [AI-ASSISTANCE.md](https://github.com/mimran1980/ergon/blob/first_cut/sbe/AI-ASSISTANCE.md).
...
2. [Core ideas](#core-ideas) — trust boundary, wire order, **buffer sizing**, flyweight vs whole struct, **composite LE layout**  
