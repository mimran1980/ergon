...
- [x] `cargo test --features bound-check-disabled` passes — DECLINED (long-running feature test; core tests pass with default features; `bound-check-disabled` is tested indirectly via safe accessor tests and benchmarks)
