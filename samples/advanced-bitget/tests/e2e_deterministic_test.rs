...
#[test] fn e2e_large_50x50()  { EXPECTED_BIDS.store(50, Ordering::Relaxed); EXPECTED_ASKS.store(50, Ordering::Relaxed); EXPECTED_SEQ.store(4, Ordering::Relaxed); run_roundtrip(b"BTCUSDT", 50, 50, 4); }
