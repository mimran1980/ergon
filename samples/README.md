...
| Lab | [`clickhouse/`](clickhouse/) | Record SBE messages and `tracing` events into ClickHouse via Aeron and a separate ingester; live table toggles; Grafana and a notebook on kind |
