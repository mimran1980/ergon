...
pub use decoder::RejectRfqCommandDecoder;
pub use encoder::RejectRfqCommandEncoder;
...
pub const SBE_TEMPLATE_ID: u16 = 109;
...
pub mod encoder {
    ...
    pub struct RejectRfqCommandEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for RejectRfqCommandEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for RejectRfqCommandEncoder<'a> {
        #[inline]
    ...
    impl<'a> RejectRfqCommandEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct RejectRfqCommandDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for RejectRfqCommandDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for RejectRfqCommandDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for RejectRfqCommandDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> RejectRfqCommandDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
