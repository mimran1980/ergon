...
pub use decoder::AddInstrumentResultDecoder;
pub use encoder::AddInstrumentResultEncoder;
...
pub const SBE_TEMPLATE_ID: u16 = 120;
...
pub mod encoder {
    ...
    pub struct AddInstrumentResultEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for AddInstrumentResultEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for AddInstrumentResultEncoder<'a> {
        #[inline]
    ...
    impl<'a> AddInstrumentResultEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct AddInstrumentResultDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for AddInstrumentResultDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for AddInstrumentResultDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for AddInstrumentResultDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> AddInstrumentResultDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
