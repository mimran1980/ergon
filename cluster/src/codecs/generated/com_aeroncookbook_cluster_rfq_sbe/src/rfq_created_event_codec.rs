...
pub use decoder::RfqCreatedEventDecoder;
pub use encoder::RfqCreatedEventEncoder;
...
pub const SBE_TEMPLATE_ID: u16 = 112;
...
pub mod encoder {
    ...
    pub struct RfqCreatedEventEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for RfqCreatedEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for RfqCreatedEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> RfqCreatedEventEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct RfqCreatedEventDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for RfqCreatedEventDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for RfqCreatedEventDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for RfqCreatedEventDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> RfqCreatedEventDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        pub fn requester_side(&self) -> side::Side {
            self.get_buf().get_i32_at(self.offset + 25).into()
        }
