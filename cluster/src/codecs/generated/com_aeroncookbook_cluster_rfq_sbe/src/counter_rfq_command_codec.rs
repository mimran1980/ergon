...
pub use decoder::CounterRfqCommandDecoder;
pub use encoder::CounterRfqCommandEncoder;
...
pub mod encoder {
    ...
    pub struct CounterRfqCommandEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for CounterRfqCommandEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for CounterRfqCommandEncoder<'a> {
        #[inline]
    ...
    impl<'a> CounterRfqCommandEncoder<'a> {
        ...
        /// - version: 0
        #[inline]
        pub fn counter_user_id(&mut self, value: i32) -> &mut Self {
...
pub mod decoder {
    ...
    pub struct CounterRfqCommandDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for CounterRfqCommandDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for CounterRfqCommandDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for CounterRfqCommandDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> CounterRfqCommandDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        /// primitive field - 'REQUIRED'
        #[inline]
        pub fn counter_user_id(&self) -> i32 {
