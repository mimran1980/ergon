...
pub use decoder::AcceptRfqConfirmEventDecoder;
pub use encoder::AcceptRfqConfirmEventEncoder;
...
pub const SBE_TEMPLATE_ID: u16 = 127;
...
pub mod encoder {
    ...
    pub struct AcceptRfqConfirmEventEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for AcceptRfqConfirmEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for AcceptRfqConfirmEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> AcceptRfqConfirmEventEncoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn result(&mut self, value: accept_rfq_result::AcceptRfqResult) -> &mut Self {
...
pub mod decoder {
    ...
    pub struct AcceptRfqConfirmEventDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for AcceptRfqConfirmEventDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for AcceptRfqConfirmEventDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for AcceptRfqConfirmEventDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> AcceptRfqConfirmEventDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        /// REQUIRED enum
        #[inline]
        pub fn result(&self) -> accept_rfq_result::AcceptRfqResult {
