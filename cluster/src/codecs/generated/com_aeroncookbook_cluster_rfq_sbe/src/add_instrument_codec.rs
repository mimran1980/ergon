...
pub use decoder::AddInstrumentDecoder;
pub use encoder::AddInstrumentEncoder;
...
pub mod encoder {
    ...
    pub struct AddInstrumentEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for AddInstrumentEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for AddInstrumentEncoder<'a> {
        #[inline]
...
pub mod decoder {
    ...
    pub struct AddInstrumentDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for AddInstrumentDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for AddInstrumentDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for AddInstrumentDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> AddInstrumentDecoder<'a> {
        ...
        pub fn min_size(&self) -> i32 {
            self.get_buf().get_i32_at(self.offset + 49)
        }
