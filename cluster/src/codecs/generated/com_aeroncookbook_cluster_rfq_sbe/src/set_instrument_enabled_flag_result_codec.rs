...
pub use decoder::SetInstrumentEnabledFlagResultDecoder;
pub use encoder::SetInstrumentEnabledFlagResultEncoder;
...
pub mod encoder {
    ...
    pub struct SetInstrumentEnabledFlagResultEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for SetInstrumentEnabledFlagResultEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for SetInstrumentEnabledFlagResultEncoder<'a> {
        #[inline]
    ...
    impl<'a> SetInstrumentEnabledFlagResultEncoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn result(&mut self, value: request_result::RequestResult) -> &mut Self {
...
pub mod decoder {
    ...
    pub struct SetInstrumentEnabledFlagResultDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for SetInstrumentEnabledFlagResultDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for SetInstrumentEnabledFlagResultDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for SetInstrumentEnabledFlagResultDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> SetInstrumentEnabledFlagResultDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        /// REQUIRED enum
        #[inline]
        pub fn result(&self) -> request_result::RequestResult {
