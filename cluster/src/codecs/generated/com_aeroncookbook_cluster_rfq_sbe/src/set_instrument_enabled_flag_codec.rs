...
pub use decoder::SetInstrumentEnabledFlagDecoder;
pub use encoder::SetInstrumentEnabledFlagEncoder;
...
pub mod encoder {
    ...
    pub struct SetInstrumentEnabledFlagEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for SetInstrumentEnabledFlagEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for SetInstrumentEnabledFlagEncoder<'a> {
        #[inline]
    ...
    impl<'a> SetInstrumentEnabledFlagEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct SetInstrumentEnabledFlagDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for SetInstrumentEnabledFlagDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for SetInstrumentEnabledFlagDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for SetInstrumentEnabledFlagDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> SetInstrumentEnabledFlagDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        pub fn enabled(&self) -> boolean_type::BooleanType {
            self.get_buf().get_i32_at(self.offset + 45).into()
        }
