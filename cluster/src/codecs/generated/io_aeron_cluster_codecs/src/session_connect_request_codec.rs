...
pub use decoder::SessionConnectRequestDecoder;
pub use encoder::SessionConnectRequestEncoder;
...
pub mod encoder {
    ...
    pub struct SessionConnectRequestEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for SessionConnectRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for SessionConnectRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> SessionConnectRequestEncoder<'a> {
        ...
        /// VAR_DATA ENCODER - character encoding: 'US-ASCII'
        #[inline]
        pub fn client_info(&mut self, value: &[u8]) -> &mut Self {
            let limit = self.get_limit();
            let data_length = value.len().min((u32::MAX - 1) as usize);
            self.set_limit(limit + 4 + data_length);
            self.get_buf_mut().put_u32_at(limit, data_length as u32);
...
pub mod decoder {
    ...
    pub struct SessionConnectRequestDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for SessionConnectRequestDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for SessionConnectRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for SessionConnectRequestDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> SessionConnectRequestDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        /// VAR_DATA DECODER - character encoding: 'US-ASCII'
        #[inline]
        pub fn client_info_decoder(&mut self) -> (usize, usize) {
            if self.acting_version() < 14 {
        ...
        #[inline]
        pub fn client_info_slice(&'a self, coordinates: (usize, usize)) -> &'a [u8] {
            if self.acting_version() < 14 {
                return &[] as &[u8];
            }
