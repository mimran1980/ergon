...
pub use decoder::ServiceAckDecoder;
pub use encoder::ServiceAckEncoder;
...
pub const SBE_TEMPLATE_ID: u16 = 33;
...
pub mod encoder {
    ...
    pub struct ServiceAckEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for ServiceAckEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for ServiceAckEncoder<'a> {
        #[inline]
    ...
    impl<'a> ServiceAckEncoder<'a> {
        ...
        /// - version: 0
        #[inline]
        pub fn ack_id(&mut self, value: i64) -> &mut Self {
...
pub mod decoder {
    ...
    pub struct ServiceAckDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for ServiceAckDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for ServiceAckDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for ServiceAckDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
