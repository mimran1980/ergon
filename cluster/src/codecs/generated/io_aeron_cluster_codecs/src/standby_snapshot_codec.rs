...
pub use decoder::StandbySnapshotDecoder;
pub use encoder::StandbySnapshotEncoder;
...
pub const SBE_TEMPLATE_ID: u16 = 81;
...
pub mod encoder {
    ...
    pub struct StandbySnapshotEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for StandbySnapshotEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for StandbySnapshotEncoder<'a> {
        #[inline]
    ...
    impl<'a> StandbySnapshotEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct StandbySnapshotDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for StandbySnapshotDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for StandbySnapshotDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for StandbySnapshotDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> StandbySnapshotDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        pub fn response_stream_id(&self) -> i32 {
            self.get_buf().get_i32_at(self.offset + 12)
        }
