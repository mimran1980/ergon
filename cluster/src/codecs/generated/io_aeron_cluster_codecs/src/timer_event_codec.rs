...
pub use decoder::TimerEventDecoder;
pub use encoder::TimerEventEncoder;
...
pub mod encoder {
    ...
    pub struct TimerEventEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for TimerEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for TimerEventEncoder<'a> {
        #[inline]
...
pub mod decoder {
    ...
    pub struct TimerEventDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for TimerEventDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for TimerEventDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for TimerEventDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
