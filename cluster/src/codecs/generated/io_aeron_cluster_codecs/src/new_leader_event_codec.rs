...
pub use decoder::NewLeaderEventDecoder;
pub use encoder::NewLeaderEventEncoder;
...
pub mod encoder {
    ...
    pub struct NewLeaderEventEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for NewLeaderEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for NewLeaderEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> NewLeaderEventEncoder<'a> {
        ...
        #[inline]
        pub fn ingress_endpoints(&mut self, value: &[u8]) -> &mut Self {
...
pub mod decoder {
    ...
    pub struct NewLeaderEventDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for NewLeaderEventDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for NewLeaderEventDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for NewLeaderEventDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> NewLeaderEventDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        #[inline]
        pub fn ingress_endpoints_decoder(&mut self) -> (usize, usize) {
        ...
        #[inline]
        pub fn ingress_endpoints_slice(&'a self, coordinates: (usize, usize)) -> &'a [u8] {
