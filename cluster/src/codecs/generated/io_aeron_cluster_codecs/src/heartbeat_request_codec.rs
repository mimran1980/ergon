...
pub use decoder::HeartbeatRequestDecoder;
pub use encoder::HeartbeatRequestEncoder;
...
pub const SBE_TEMPLATE_ID: u16 = 79;
...
pub mod encoder {
    ...
    pub struct HeartbeatRequestEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for HeartbeatRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for HeartbeatRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> HeartbeatRequestEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct HeartbeatRequestDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for HeartbeatRequestDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for HeartbeatRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for HeartbeatRequestDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> HeartbeatRequestDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
