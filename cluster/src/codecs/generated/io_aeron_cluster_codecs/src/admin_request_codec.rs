...
pub use decoder::AdminRequestDecoder;
pub use encoder::AdminRequestEncoder;
...
pub const SBE_TEMPLATE_ID: u16 = 26;
...
pub mod encoder {
    ...
    pub struct AdminRequestEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for AdminRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for AdminRequestEncoder<'a> {
        #[inline]
...
pub mod decoder {
    ...
    pub struct AdminRequestDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for AdminRequestDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for AdminRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for AdminRequestDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
