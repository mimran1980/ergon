...
pub use decoder::NewLeadershipTermEventDecoder;
pub use encoder::NewLeadershipTermEventEncoder;
...
pub mod encoder {
    ...
    pub struct NewLeadershipTermEventEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for NewLeadershipTermEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for NewLeadershipTermEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> NewLeadershipTermEventEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct NewLeadershipTermEventDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for NewLeadershipTermEventDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for NewLeadershipTermEventDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for NewLeadershipTermEventDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> NewLeadershipTermEventDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
