...
pub use decoder::CommitPositionDecoder;
pub use encoder::CommitPositionEncoder;
...
pub mod encoder {
    ...
    pub struct CommitPositionEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for CommitPositionEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for CommitPositionEncoder<'a> {
        #[inline]
    ...
    impl<'a> CommitPositionEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct CommitPositionDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for CommitPositionDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for CommitPositionDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for CommitPositionDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> CommitPositionDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
