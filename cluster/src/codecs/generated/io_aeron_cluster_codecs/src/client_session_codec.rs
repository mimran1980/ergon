...
pub use decoder::ClientSessionDecoder;
pub use encoder::ClientSessionEncoder;
...
pub mod encoder {
    ...
    pub struct ClientSessionEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for ClientSessionEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for ClientSessionEncoder<'a> {
        #[inline]
...
pub mod decoder {
    ...
    pub struct ClientSessionDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for ClientSessionDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for ClientSessionDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for ClientSessionDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
