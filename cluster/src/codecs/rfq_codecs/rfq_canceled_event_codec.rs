...
pub use decoder::RfqCanceledEventDecoder;
pub use encoder::RfqCanceledEventEncoder;
...
pub const SBE_TEMPLATE_ID: u16 = 111;
...
pub mod encoder {
    ...
    pub struct RfqCanceledEventEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for RfqCanceledEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for RfqCanceledEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> RfqCanceledEventEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct RfqCanceledEventDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for RfqCanceledEventDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for RfqCanceledEventDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for RfqCanceledEventDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> RfqCanceledEventDecoder<'a> {
