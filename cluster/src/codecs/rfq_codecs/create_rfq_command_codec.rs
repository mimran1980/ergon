...
pub use decoder::CreateRfqCommandDecoder;
pub use encoder::CreateRfqCommandEncoder;

pub use super::SBE_SCHEMA_ID;
pub use super::SBE_SCHEMA_VERSION;
pub use super::SBE_SEMANTIC_VERSION;

pub const SBE_BLOCK_LENGTH: u16 = 69;
...
pub mod encoder {
    ...
    pub struct CreateRfqCommandEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for CreateRfqCommandEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for CreateRfqCommandEncoder<'a> {
        #[inline]
    ...
    impl<'a> CreateRfqCommandEncoder<'a> {
        ...
        /// - version: 0
        #[inline]
        pub fn expire_time_ms(&mut self, value: i64) -> &mut Self {
        ...
        /// - version: 0
        #[inline]
        pub fn quantity(&mut self, value: i64) -> &mut Self {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn requester_side(&mut self, value: side::Side) -> &mut Self {
...
pub mod decoder {
    ...
    pub struct CreateRfqCommandDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for CreateRfqCommandDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for CreateRfqCommandDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for CreateRfqCommandDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> CreateRfqCommandDecoder<'a> {
        ...
        #[inline]
        pub fn expire_time_ms(&self) -> i64 {
        ...
        pub fn quantity(&self) -> i64 {
            self.get_buf().get_i64_at(self.offset + 44)
        }

        /// REQUIRED enum
        #[inline]
        pub fn requester_side(&self) -> side::Side {
            self.get_buf().get_i32_at(self.offset + 52).into()
        }
        ...
        pub fn requester_user_id(&self) -> i32 {
            self.get_buf().get_i32_at(self.offset + 65)
        }
    }
} // end decoder
