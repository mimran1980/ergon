...
pub mod encoder {
    ...
    impl<'a, P> Writer<'a> for ValuesEncoder<P>
    where
        P: Writer<'a> + Default,
    {
        #[inline]
    ...
    impl<'a, P> Encoder<'a> for ValuesEncoder<P>
    where
        P: Encoder<'a> + Default,
    {
        #[inline]
...
pub mod decoder {
    ...
    impl<'a, P> ActingVersion for ValuesDecoder<P>
    where
    ...
    impl<'a, P> Reader<'a> for ValuesDecoder<P>
    where
        P: Reader<'a> + Default,
    {
        #[inline]
    ...
    impl<'a, P> Decoder<'a> for ValuesDecoder<P>
    where
