...
pub use decoder::CancelRfqCommandDecoder;
pub use encoder::CancelRfqCommandEncoder;
...
pub mod encoder {
    ...
    pub struct CancelRfqCommandEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for CancelRfqCommandEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for CancelRfqCommandEncoder<'a> {
        #[inline]
    ...
    impl<'a> CancelRfqCommandEncoder<'a> {
        ...
        /// - version: 0
        #[inline]
        pub fn cancel_user_id(&mut self, value: i32) -> &mut Self {
...
pub mod decoder {
    ...
    pub struct CancelRfqCommandDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for CancelRfqCommandDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for CancelRfqCommandDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for CancelRfqCommandDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> CancelRfqCommandDecoder<'a> {
        ...
        /// primitive field - 'REQUIRED'
        #[inline]
        pub fn cancel_user_id(&self) -> i32 {
