...
pub use decoder::ListInstrumentsCommandDecoder;
pub use encoder::ListInstrumentsCommandEncoder;
...
pub mod encoder {
    ...
    pub struct ListInstrumentsCommandEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for ListInstrumentsCommandEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for ListInstrumentsCommandEncoder<'a> {
        #[inline]
    ...
    impl<'a> ListInstrumentsCommandEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct ListInstrumentsCommandDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for ListInstrumentsCommandDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for ListInstrumentsCommandDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for ListInstrumentsCommandDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> ListInstrumentsCommandDecoder<'a> {
