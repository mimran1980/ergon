...
pub use decoder::QuoteRfqConfirmEventDecoder;
pub use encoder::QuoteRfqConfirmEventEncoder;
...
pub const SBE_TEMPLATE_ID: u16 = 124;
...
pub mod encoder {
    ...
    pub struct QuoteRfqConfirmEventEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for QuoteRfqConfirmEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for QuoteRfqConfirmEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> QuoteRfqConfirmEventEncoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn result(&mut self, value: quote_rfq_result::QuoteRfqResult) -> &mut Self {
...
pub mod decoder {
    ...
    pub struct QuoteRfqConfirmEventDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for QuoteRfqConfirmEventDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for QuoteRfqConfirmEventDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for QuoteRfqConfirmEventDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> QuoteRfqConfirmEventDecoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn result(&self) -> quote_rfq_result::QuoteRfqResult {
