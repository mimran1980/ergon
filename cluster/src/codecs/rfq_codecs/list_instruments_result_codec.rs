...
pub use decoder::ListInstrumentsResultDecoder;
pub use encoder::ListInstrumentsResultEncoder;
...
pub const SBE_TEMPLATE_ID: u16 = 118;
...
pub mod encoder {
    ...
    pub struct ListInstrumentsResultEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for ListInstrumentsResultEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for ListInstrumentsResultEncoder<'a> {
        #[inline]
    ...
    impl<'a> ListInstrumentsResultEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct ListInstrumentsResultDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for ListInstrumentsResultDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for ListInstrumentsResultDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for ListInstrumentsResultDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> ListInstrumentsResultDecoder<'a> {
