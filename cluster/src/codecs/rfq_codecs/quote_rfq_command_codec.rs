...
pub use decoder::QuoteRfqCommandDecoder;
pub use encoder::QuoteRfqCommandEncoder;
...
pub const SBE_TEMPLATE_ID: u16 = 108;
...
pub mod encoder {
    ...
    pub struct QuoteRfqCommandEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for QuoteRfqCommandEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for QuoteRfqCommandEncoder<'a> {
        #[inline]
    ...
    impl<'a> QuoteRfqCommandEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct QuoteRfqCommandDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for QuoteRfqCommandDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for QuoteRfqCommandDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for QuoteRfqCommandDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> QuoteRfqCommandDecoder<'a> {
