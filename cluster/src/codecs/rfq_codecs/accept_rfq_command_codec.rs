...
pub use decoder::AcceptRfqCommandDecoder;
pub use encoder::AcceptRfqCommandEncoder;
...
pub mod encoder {
    ...
    pub struct AcceptRfqCommandEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for AcceptRfqCommandEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for AcceptRfqCommandEncoder<'a> {
        #[inline]
    ...
    impl<'a> AcceptRfqCommandEncoder<'a> {
        ...
        /// - version: 0
        #[inline]
        pub fn accept_user_id(&mut self, value: i32) -> &mut Self {
...
pub mod decoder {
    ...
    pub struct AcceptRfqCommandDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for AcceptRfqCommandDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for AcceptRfqCommandDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for AcceptRfqCommandDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> AcceptRfqCommandDecoder<'a> {
        ...
        /// primitive field - 'REQUIRED'
        #[inline]
        pub fn accept_user_id(&self) -> i32 {
