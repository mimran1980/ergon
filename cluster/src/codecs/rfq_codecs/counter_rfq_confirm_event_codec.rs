...
pub use decoder::CounterRfqConfirmEventDecoder;
pub use encoder::CounterRfqConfirmEventEncoder;
...
pub const SBE_TEMPLATE_ID: u16 = 125;
...
pub mod encoder {
    ...
    pub struct CounterRfqConfirmEventEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for CounterRfqConfirmEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for CounterRfqConfirmEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> CounterRfqConfirmEventEncoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn result(&mut self, value: counter_rfq_result::CounterRfqResult) -> &mut Self {
...
pub mod decoder {
    ...
    pub struct CounterRfqConfirmEventDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for CounterRfqConfirmEventDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for CounterRfqConfirmEventDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for CounterRfqConfirmEventDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> CounterRfqConfirmEventDecoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn result(&self) -> counter_rfq_result::CounterRfqResult {
