...
pub use decoder::CancelRfqConfirmEventDecoder;
pub use encoder::CancelRfqConfirmEventEncoder;
...
pub const SBE_TEMPLATE_ID: u16 = 123;
...
pub mod encoder {
    ...
    pub struct CancelRfqConfirmEventEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for CancelRfqConfirmEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for CancelRfqConfirmEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> CancelRfqConfirmEventEncoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn result(&mut self, value: cancel_rfq_result::CancelRfqResult) -> &mut Self {
...
pub mod decoder {
    ...
    pub struct CancelRfqConfirmEventDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for CancelRfqConfirmEventDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for CancelRfqConfirmEventDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for CancelRfqConfirmEventDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> CancelRfqConfirmEventDecoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn result(&self) -> cancel_rfq_result::CancelRfqResult {
