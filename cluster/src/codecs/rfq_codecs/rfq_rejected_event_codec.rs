...
pub use decoder::RfqRejectedEventDecoder;
pub use encoder::RfqRejectedEventEncoder;
...
pub const SBE_TEMPLATE_ID: u16 = 116;
...
pub mod encoder {
    ...
    pub struct RfqRejectedEventEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for RfqRejectedEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for RfqRejectedEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> RfqRejectedEventEncoder<'a> {
        ...
        /// primitive field 'rejectedByUserId'
        /// - min value: -2147483647
        /// - max value: 2147483647
        /// - null value: -2147483648_i32
        /// - characterEncoding: null
        ...
        /// - version: 0
        #[inline]
        pub fn rejected_by_user_id(&mut self, value: i32) -> &mut Self {
...
pub mod decoder {
    ...
    pub struct RfqRejectedEventDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for RfqRejectedEventDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for RfqRejectedEventDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for RfqRejectedEventDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> RfqRejectedEventDecoder<'a> {
        ...
        /// primitive field - 'REQUIRED'
        #[inline]
        pub fn rejected_by_user_id(&self) -> i32 {
        ...
        pub fn price(&self) -> i64 {
            self.get_buf().get_i64_at(self.offset + 52)
        }
    }
} // end decoder
