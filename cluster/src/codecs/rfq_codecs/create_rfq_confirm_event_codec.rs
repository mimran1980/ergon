...
pub use decoder::CreateRfqConfirmEventDecoder;
pub use encoder::CreateRfqConfirmEventEncoder;
...
pub const SBE_TEMPLATE_ID: u16 = 122;
...
pub mod encoder {
    ...
    pub struct CreateRfqConfirmEventEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for CreateRfqConfirmEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for CreateRfqConfirmEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> CreateRfqConfirmEventEncoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn result(&mut self, value: create_rfq_result::CreateRfqResult) -> &mut Self {
...
pub mod decoder {
    ...
    pub struct CreateRfqConfirmEventDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for CreateRfqConfirmEventDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for CreateRfqConfirmEventDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for CreateRfqConfirmEventDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> CreateRfqConfirmEventDecoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn result(&self) -> create_rfq_result::CreateRfqResult {
