...
pub use decoder::RejectRfqConfirmEventDecoder;
pub use encoder::RejectRfqConfirmEventEncoder;
...
pub const SBE_TEMPLATE_ID: u16 = 128;
...
pub mod encoder {
    ...
    pub struct RejectRfqConfirmEventEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for RejectRfqConfirmEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for RejectRfqConfirmEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> RejectRfqConfirmEventEncoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn result(&mut self, value: reject_rfq_result::RejectRfqResult) -> &mut Self {
...
pub mod decoder {
    ...
    pub struct RejectRfqConfirmEventDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for RejectRfqConfirmEventDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for RejectRfqConfirmEventDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for RejectRfqConfirmEventDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> RejectRfqConfirmEventDecoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn result(&self) -> reject_rfq_result::RejectRfqResult {
