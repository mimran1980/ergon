...
pub use decoder::SessionCloseRequestDecoder;
pub use encoder::SessionCloseRequestEncoder;
...
pub mod encoder {
    ...
    pub struct SessionCloseRequestEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for SessionCloseRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for SessionCloseRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> SessionCloseRequestEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct SessionCloseRequestDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for SessionCloseRequestDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for SessionCloseRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for SessionCloseRequestDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> SessionCloseRequestDecoder<'a> {
