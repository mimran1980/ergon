...
pub use decoder::TerminationAckDecoder;
pub use encoder::TerminationAckEncoder;
...
pub const SBE_TEMPLATE_ID: u16 = 76;
...
pub mod encoder {
    ...
    pub struct TerminationAckEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for TerminationAckEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for TerminationAckEncoder<'a> {
        #[inline]
    ...
    impl<'a> TerminationAckEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct TerminationAckDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for TerminationAckDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for TerminationAckDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for TerminationAckDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> TerminationAckDecoder<'a> {
