...
pub use decoder::CatchupPositionDecoder;
pub use encoder::CatchupPositionEncoder;
...
pub mod encoder {
    ...
    pub struct CatchupPositionEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for CatchupPositionEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for CatchupPositionEncoder<'a> {
        #[inline]
    ...
    impl<'a> CatchupPositionEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct CatchupPositionDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for CatchupPositionDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for CatchupPositionDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for CatchupPositionDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> CatchupPositionDecoder<'a> {
