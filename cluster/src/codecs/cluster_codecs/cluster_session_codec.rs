...
pub use decoder::ClusterSessionDecoder;
pub use encoder::ClusterSessionEncoder;
...
pub mod encoder {
    ...
    pub struct ClusterSessionEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for ClusterSessionEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for ClusterSessionEncoder<'a> {
        #[inline]
    ...
    impl<'a> ClusterSessionEncoder<'a> {
        ...
        /// primitive field 'openedLogPosition'
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808_i64
        /// - characterEncoding: null
        ...
        /// - version: 0
        #[inline]
        pub fn opened_log_position(&mut self, value: i64) -> &mut Self {
            let offset = self.offset + 16;
            self.get_buf_mut().put_i64_at(offset, value);
            self
        }

        /// primitive field 'timeOfLastActivity'
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808_i64
        /// - characterEncoding: null
        ...
        /// - version: 0
        #[inline]
        pub fn time_of_last_activity(&mut self, value: i64) -> &mut Self {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn close_reason(&mut self, value: close_reason::CloseReason) -> &mut Self {
...
pub mod decoder {
    ...
    pub struct ClusterSessionDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for ClusterSessionDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for ClusterSessionDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for ClusterSessionDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> ClusterSessionDecoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn close_reason(&self) -> close_reason::CloseReason {
