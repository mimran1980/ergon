...
pub use decoder::StopCatchupDecoder;
pub use encoder::StopCatchupEncoder;
...
pub mod encoder {
    ...
    pub struct StopCatchupEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for StopCatchupEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for StopCatchupEncoder<'a> {
        #[inline]
...
pub mod decoder {
    ...
    pub struct StopCatchupDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for StopCatchupDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for StopCatchupDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for StopCatchupDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
