...
pub use decoder::JoinClusterDecoder;
pub use encoder::JoinClusterEncoder;
...
pub const SBE_TEMPLATE_ID: u16 = 74;
...
pub mod encoder {
    ...
    pub struct JoinClusterEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for JoinClusterEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for JoinClusterEncoder<'a> {
        #[inline]
...
pub mod decoder {
    ...
    pub struct JoinClusterDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for JoinClusterDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for JoinClusterDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for JoinClusterDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
