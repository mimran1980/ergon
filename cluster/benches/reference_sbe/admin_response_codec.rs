...
pub use decoder::AdminResponseDecoder;
pub use encoder::AdminResponseEncoder;
...
pub const SBE_TEMPLATE_ID: u16 = 27;
...
pub mod encoder {
    ...
    pub struct AdminResponseEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for AdminResponseEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for AdminResponseEncoder<'a> {
        #[inline]
    ...
    impl<'a> AdminResponseEncoder<'a> {
        ...
        #[inline]
        pub fn request_type(&mut self, value: admin_request_type::AdminRequestType) -> &mut Self {
        ...
        #[inline]
        pub fn response_code(&mut self, value: admin_response_code::AdminResponseCode) -> &mut Self {
        ...
        #[inline]
        pub fn message(&mut self, value: &[u8]) -> &mut Self {
        ...
        #[inline]
        pub fn payload(&mut self, value: &[u8]) -> &mut Self {
            let limit = self.get_limit();
            let data_length = value.len().min((u32::MAX - 1) as usize);
            self.set_limit(limit + 4 + data_length);
            self.get_buf_mut().put_u32_at(limit, data_length as u32);
...
pub mod decoder {
    ...
    pub struct AdminResponseDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for AdminResponseDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for AdminResponseDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for AdminResponseDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> AdminResponseDecoder<'a> {
        ...
        /// - description: A type of the admin request that was executed.
        #[inline]
        pub fn request_type(&self) -> admin_request_type::AdminRequestType {
            self.get_buf().get_i32_at(self.offset + 16).into()
        }

        /// REQUIRED enum
        /// - description: A response code describing the result.
        #[inline]
        pub fn response_code(&self) -> admin_response_code::AdminResponseCode {
        ...
        /// - description: A response message (e.g. an error message).
        #[inline]
        pub fn message_decoder(&mut self) -> (usize, usize) {
        ...
        #[inline]
        pub fn message_slice(&'a self, coordinates: (usize, usize)) -> &'a [u8] {
