...
pub use decoder::MembershipChangeEventDecoder;
pub use encoder::MembershipChangeEventEncoder;
...
pub const SBE_TEMPLATE_ID: u16 = 25;
...
pub mod encoder {
    ...
    pub struct MembershipChangeEventEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for MembershipChangeEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for MembershipChangeEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> MembershipChangeEventEncoder<'a> {
        ...
        /// - version: 0
        #[inline]
        pub fn cluster_size(&mut self, value: i32) -> &mut Self {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn change_type(&mut self, value: change_type::ChangeType) -> &mut Self {
...
pub mod decoder {
    ...
    pub struct MembershipChangeEventDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for MembershipChangeEventDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for MembershipChangeEventDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for MembershipChangeEventDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> MembershipChangeEventDecoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn change_type(&self) -> change_type::ChangeType {
