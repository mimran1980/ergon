...
pub use decoder::VoteDecoder;
pub use encoder::VoteEncoder;
...
pub mod encoder {
    ...
    impl<'a> Writer<'a> for VoteEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for VoteEncoder<'a> {
        #[inline]
    ...
    impl<'a> VoteEncoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn vote(&mut self, value: boolean_type::BooleanType) -> &mut Self {
...
pub mod decoder {
    ...
    impl ActingVersion for VoteDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for VoteDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for VoteDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> VoteDecoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn vote(&self) -> boolean_type::BooleanType {
