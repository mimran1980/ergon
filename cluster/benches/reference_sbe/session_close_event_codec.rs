...
pub use decoder::SessionCloseEventDecoder;
pub use encoder::SessionCloseEventEncoder;
...
pub mod encoder {
    ...
    pub struct SessionCloseEventEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for SessionCloseEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for SessionCloseEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> SessionCloseEventEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct SessionCloseEventDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for SessionCloseEventDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for SessionCloseEventDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for SessionCloseEventDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> SessionCloseEventDecoder<'a> {
