...
pub use decoder::CloseSessionDecoder;
pub use encoder::CloseSessionEncoder;
...
pub mod encoder {
    ...
    pub struct CloseSessionEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for CloseSessionEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for CloseSessionEncoder<'a> {
        #[inline]
...
pub mod decoder {
    ...
    pub struct CloseSessionDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for CloseSessionDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for CloseSessionDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for CloseSessionDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
