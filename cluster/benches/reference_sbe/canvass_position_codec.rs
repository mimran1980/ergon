...
pub use decoder::CanvassPositionDecoder;
pub use encoder::CanvassPositionEncoder;
...
pub mod encoder {
    ...
    pub struct CanvassPositionEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for CanvassPositionEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for CanvassPositionEncoder<'a> {
        #[inline]
    ...
    impl<'a> CanvassPositionEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct CanvassPositionDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for CanvassPositionDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for CanvassPositionDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for CanvassPositionDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> CanvassPositionDecoder<'a> {
