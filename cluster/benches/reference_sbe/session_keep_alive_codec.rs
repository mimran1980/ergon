...
pub use decoder::SessionKeepAliveDecoder;
pub use encoder::SessionKeepAliveEncoder;
...
pub mod encoder {
    ...
    pub struct SessionKeepAliveEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for SessionKeepAliveEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for SessionKeepAliveEncoder<'a> {
        #[inline]
    ...
    impl<'a> SessionKeepAliveEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct SessionKeepAliveDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for SessionKeepAliveDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for SessionKeepAliveDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for SessionKeepAliveDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> SessionKeepAliveDecoder<'a> {
