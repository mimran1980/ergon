...
const GOLDEN_SESSION_CONNECT_REQUEST: [u8; 74] = [
    ...
    0x39, 0x39, 0x39, 0x39, 0x09, 0x00, 0x00, 0x00, 0x75, 0x73, 0x65, 0x72, 0x3a, 0x70, 0x61, 0x73, 0x73,
];
...
fn parity_session_connect_request() {
    ...
    let _ = e.header(0);
    assert_eq!(&b[..74], &GOLDEN_SESSION_CONNECT_REQUEST[..]);
}
