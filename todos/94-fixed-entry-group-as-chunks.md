...
- [x] Generate `fn entry_at(&self, index: usize) -> Result<EntryDecoder<'a>, DecodeError>` for random access
...
- [x] Benchmark: `as_chunks()` vs standard iterator for fixed-entry groups
